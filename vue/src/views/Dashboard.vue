            ...
            <div class="bg-white shadow-md p-4 row-span-2 order-3 lg:order-1 animate-fade-in-down">
                ...
                <div class="flex justify-between">
                    <router-link
                        ...
                        class="flex py-2 px-4 text-sm border border-transparent rounded-md text-indigo-500 hover:text-white hover:bg-indigo-700 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                        <svg
