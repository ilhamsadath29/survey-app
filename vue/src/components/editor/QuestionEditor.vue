        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center">
                ...
                <button
                    type="button"
                    @click="addQuestion()"
                    class="flex items-center text-sm py-1 px-4 mr-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700"
                >
                    <svg
                ...
                <button
                    ...
                    class="flex items-center text-xs py-1 px-4 rounded-sm border border-transparent text-red-500 hover:border-red-600"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-5 w-5"
        ...
        <div>
            <div v-if="shouldHaveOption()" class="mt-2">
                ...
                <div
                    ...
                    class="text-xs text-gray-600 text-center py3"
                >You don't have any options</div>
                ...
                >
                    ...
                    <input
                        ...
                        v-model="option.text"
                        @change="dataChange"
                        class="w-full py-1 px-2 text-xm border border-gray-300 focus:border-indigo-500 rounded-sm"
                    />
