    ...
    <div class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 h-[470px]">
        ...
        <div class="flex justify-between items-center mt-3">
            <router-link
                ...
                class="flex py-2 px-4 text-white border border-transparent text-sm rounded-md bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
                <svg
